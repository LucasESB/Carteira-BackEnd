...
public class DataHora {
    ...
    public static Date getDataAtual(String formato) throws ParseException {
        return stringParseDate(formatarData(new Date(), formato), formato);
    }
    ...
    public Date incremetarData(Date data, int qtd, int campo) {
        Calendar cal = Calendar.getInstance();
        cal.setTime(data);
